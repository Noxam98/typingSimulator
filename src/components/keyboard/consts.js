const codeToData = {
    ...
    F1:           [{lang: 'en', value: '',  shift: '', label: ''},  {lang: 'ua', value: "",  shift: ''},  {lang: 'ru', value: '',  shift: ''}],
    F2:           [{lang: 'en', value: '',  shift: '', label: ''},  {lang: 'ua', value: "",  shift: ''},  {lang: 'ru', value: '',  shift: ''}],
    F3:           [{lang: 'en', value: '',  shift: '', label: ''},  {lang: 'ua', value: "",  shift: ''},  {lang: 'ru', value: '',  shift: ''}],
    F4:           [{lang: 'en', value: '',  shift: '', label: ''},  {lang: 'ua', value: "",  shift: ''},  {lang: 'ru', value: '',  shift: ''}],
    F5:           [{lang: 'en', value: '',  shift: '', label: ''},  {lang: 'ua', value: "",  shift: '', label: ''},  {lang: 'ru', value: '',  shift: ''}],
    F6:           [{lang: 'en', value: '',  shift: '', label: ''},  {lang: 'ua', value: "",  shift: '', label: ''},  {lang: 'ru', value: '',  shift: ''}],
    F7:           [{lang: 'en', value: '',  shift: '', label: ''},  {lang: 'ua', value: "",  shift: '', label: ''},  {lang: 'ru', value: '',  shift: ''}],
    F8:           [{lang: 'en', value: '',  shift: '', label: ''},  {lang: 'ua', value: "",  shift: '', label: ''},  {lang: 'ru', value: '',  shift: ''}],
    F9:           [{lang: 'en', value: '',  shift: '', label: ''},  {lang: 'ua', value: "",  shift: '', label: ''},  {lang: 'ru', value: '',  shift: ''}],
    F10:          [{lang: 'en', value: '',  shift: '', label: ''},  {lang: 'ua', value: "",  shift: '', label: ''},  {lang: 'ru', value: '',  shift: ''}],
    F11:          [{lang: 'en', value: '',  shift: '', label: ''},  {lang: 'ua', value: "",  shift: '', label: ''},  {lang: 'ru', value: '',  shift: ''}],
    F12:          [{lang: 'en', value: '',  shift: '', label: ''},  {lang: 'ua', value: "",  shift: '', label: ''},  {lang: 'ru', value: '',  shift: ''}],
    Tab:          [{lang: 'en', value: '',  shift: '', label: ''},  {lang: 'ua', value: "",  shift: '', label: ''},  {lang: 'ru', value: '',  shift: ''}],
    ...
    KeyS:         [{lang: 'en', value: 's', shift: 'S'}, {lang: 'ua', value: "і", shift: 'І'}, {lang: 'ru', value: 'ы', shift: 'Ы'}],
    ...
    Backspace:    [{lang: 'en', value: '',  shift: '', label: '<=='},  {lang: 'ua', value: "",  shift: '', label: '<=='},  {lang: 'ru', value: '',  shift: '', label: '<=='}],
    ...
    Space:        [{lang: 'en', value: ' ', shift: ' ', label: ' '}, {lang: 'ua', value: " ", shift: ' ', label: ' '}, {lang: 'ru', value: ' ', shift: ' ', label: ' '}],
    ...
    Fn:           [{lang: 'en', value: '', shift: '', label: 'Fn'}, {lang: 'ua', value: "", shift: '', label: 'Fn'}, {lang: 'ru', value: '', shift: '', label: 'Fn'}],
}
...
const keyboards = {
    ...
    types: {
        ...
        laptop: [
            [{code: 'Escape', width: 1.024}, {code: 'F1', width: 1.024}, {code: 'F2', width: 1.024}, {code: 'F3', width: 1.024}, {code: 'F4', width: 1.024}, {code: 'F5', width: 1.024}, {code: 'F6', width: 1.024}, {code: 'F7', width: 1.024}, {code: 'F8', width: 1.024}, {code: 'F9', width: 1.024}, {code: 'F10', width: 1.024}, {code: 'F11', width: 1.024}, {code: 'F12', width: 1.024}, {code: 'Delete', width: 1.35}],
            [{code: 'Backquote', width: .7}, {code: 'Digit1'}, {code: 'Digit2'}, {code: 'Digit3'}, {code: 'Digit4'}, {code: 'Digit5'}, {code: 'Digit6'}, {code: 'Digit7'}, {code: 'Digit8'}, {code: 'Digit9'}, {code: 'Digit0'}, {code: 'Minus'}, {code: 'Equal'}, {code: 'Backspace', width: 1.95}],
            ...
            [{code: 'ControlLeft'}, {code: 'Fn', disable: true}, {code: 'Windows', disable: true}, {code: 'AltLeft'}, {code: 'Space', width: 6.15, label: ' '} , {code: 'AltRight'}, {code: 'ControlRight'}, {code: 'ArrowLeft'}, [{code: 'ArrowUp', style: {}}, {code: 'ArrowDown'}], {code: 'ArrowRight'}, ],
        ]
    }
